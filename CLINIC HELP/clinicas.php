...
<body>
  ...
  <header>
    <nav>
      <ul class="tabs">
        ...
        <li><a href="clinicas.php" class="active">Clínicas</a></li>
  ...
  <main class="clinicas">
    ...
    <section id="lista-clinicas" class="lista-clinicas">
      ...
      <div class="clinica-card" data-cidade="São Paulo" data-especialidade="Cardiologia">
        <img src="clinica1.jpg" alt="Clínica Coração Feliz">
        <h3>Clínica Coração Feliz</h3>
        <p>Cardiologia - São Paulo</p>
        <form action="agendar.php" method="POST">
        <input type="hidden" name="id_clin_med" value="1">
        <button type="insert" class="botao-agendar">Agendar Consulta</a></form>
      </div>

      <div class="clinica-card" data-cidade="Rio de Janeiro" data-especialidade="Dermatologia">
        <img src="clinica2.jpg" alt="Clínica Pele Viva">
        <h3>Clínica Pele Viva</h3>
        <p>Dermatologia - Rio de Janeiro</p>
        <form action="agendar.php" method="POST">
        <input type="hidden" name="id_clin_med" value="1">
        <button type="insert" class="botao-agendar">Agendar Consulta</a></form>
      </div>

      <div class="clinica-card" data-cidade="Belo Horizonte" data-especialidade="Pediatria">
        <img src="clinica3.jpg" alt="Clínica Infantil BH">
        <h3>Clínica Infantil BH</h3>
        <p>Pediatria - Belo Horizonte</p>
        <form action="agendar.php" method="POST">
        <input type="hidden" name="id_clin_med" value="1">
        <button type="insert" class="botao-agendar">Agendar Consulta</a>
</form>
      </div>
    </section>
  </main>
  ...
  <script>
    ...
    const clinicas = document.querySelectorAll('.clinica-card');

    function aplicarFiltros() {
      const cidade = cidadeFiltro.value;
      const especialidade = especialidadeFiltro.value;

      clinicas.forEach(clinica => {
        const cidadeData = clinica.dataset.cidade;
        const especialidadeData = clinica.dataset.especialidade;

        const cidadeMatch = !cidade || cidadeData === cidade;
        const especialidadeMatch = !especialidade || especialidadeData === especialidade;

        clinica.style.display = (cidadeMatch && especialidadeMatch) ? 'block' : 'none';
      });
    }
